...
export interface IStorage {
  ...
  getTemplatesByDocumentType(documentTypeId: string): Promise<Template[]>;
...
export class MemStorage implements IStorage {
  ...
  async initializeDefaultData(): Promise<void> {
    ...
    // Note: Birth Certificate document types and versions will be created automatically
    // when birth certificate templates are uploaded, not during initialization
